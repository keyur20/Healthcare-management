        ...
        <div class="w3-col 18 s12">
            <div class="w3-card-4 w3-margin w3-black">
                <div class="w3-container center-block">
                    <h1 class="text-center font-weight-bold text-info">Doctor's Schedule</h1>
                    <hr />
                    <?php
                    ...
                    if (isset($_POST["submit"])) {
                        ...
                        if (empty($booking_date)) {
                            ...
                            $update_msg = "updated ";
                            echo "<script> alert ('Your Appointment Has Been Sent Successfully! Wait For The Doctor's Approval')</script>";
                        }
                    }
                    ?>
                    <?php
                    if (isset($_GET['s_id'])) {
                        ...
                        $row = mysqli_fetch_array($db,$show_run_doctor_profile_query);
                    ?>
                        <h1 class="text-center font-weight-bold text-warning">Personal Information</h1>
                        <hr color="#333333" />
                        <h3 class="text-white">ID: <?php echo  $row['id'] . "<br />"; ?></h3>
                        <h3 class="text-white">Name: <?php echo  $row['f_name']; echo  $row['l_name'] . "<br />"; ?></h3>
                ...
                <div class="w3-card-4 w3-margin w3-black">
                    <div class="w3-container">
                        ...
                        <form class="text-center text-xl-info font-weight-bold" action="appointment_detail.php" method="POST">
                            <h3>Enter Your ID: <?php echo $drow['id']; } ?></h3>
                            <br /><b><input type="pid" name="pid" /></b>
                            <br /><br /><br />
                            <h3>Enter This ID: <?php echo $row['s_id']; } ?></h3>
                            <br />
                            <b><input type="sid" name="sid" /></b>
                            <br /><br /><br />
                            <h3><label for="booking_date">Select Date:</label></h3>
                            <br /><b><input type="date" name="booking_date"></b>
                            <br /><br /><br />
                            <h3><label for="booking_time">Select Time:</label></h3>
                            <br /><b>
                            ...
                            <br /><br />
                            <button class="btn"><i class="fa fa-2x "></i> <input style="color:#000000" class="font-weight-bold" type="submit" name="submit" value="submit"></i></button>
                            <br />
                            <?php
                            if (isset($error_msg)) {
                                echo $error_msg;
