...
<body>
<h1 class="text-center font-weight-bold text-monospace text-info">Accept Appointment</h1>
<ul class="text-center font-weight-bold text-monospace text-dark">
    ...
    <form class="text-center text-xl-info font-weight-bold" action="app.php" method="POST">
        ...
        <label for="booking_date"><b>Select Date:</b></label><br /><br />
        <input type="date" name="booking_date" required><br /><br />
        <label for="booking_time"><b>Select Time:</b></label><br /><br />
