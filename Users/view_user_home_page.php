            ...
            <div class="navbar-header">
                ...
                <div class="collapse navbar-collapse" id="myNavbar">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown">
                            <a class a dropdown-toggle" data-toggle="dropdown" href="#Appointment">Consulting<span class="caret"></span></i></a>
                            <ul class="dropdown-menu">
                        ...
                        <li><a href="accept_appointment.php"><i class="fa fa-bell"><?php if($count>0) {} echo '('.$count.')'?></i></a></li>
