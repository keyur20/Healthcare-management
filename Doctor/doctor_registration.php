  ...
  <div class="text-center panel-body bg-success">
    ...
    <form action="doctor_registration.php" method="POST" class="form-inline">
      <div class="container-fluid text-center bg-grey col-50">
        ...
        ?>
        <hr>
        <label for="f_name"><i class="fa fa-user"></i> First Name :</label><br /><br />
        <input type="text" class="form-control" size="50" placeholder="Enter Your First Name" name="f_name" required><br /><br />
        <label for="l_name"><i class="fa fa-user"></i> Last Name:</label><br /><br />
        <input type="text" class="form-control" size="50" placeholder="Enter Your Last Name" name="l_name" required><br /><br />
        <label for="email"><b>Email Address:</b></label><br /><br />
        <input type="email" placeholder="Enter Your Email Address" class="form-control" size="50" name="email" required><br /><br />
        <label for="contact"><b>Contact Number:</b></label><br /><br />
        <input type="text" class="form-control" size="50" placeholder="Enter Your Contact Number" name="contact" pattern="[0-9]{11}" required><br /><br />
        ...
        <br /><br />
        <label for="qualification"><b>Qualification:</b></label><br /><br />
        <input type="text" placeholder="Enter Your Designation" class="form-control" size="50" name="qualification" required><br /><br />
        <label for="DOB"><b>DOB:</b></label><br /><br />
        <input type="date" class="form-control" size="50" name="DOB" required><br /><br />
        <label for="gender"><b>Gender:</b></label><br /><br />
        <input type="radio" name="gender" value="male" required>Male
        <br /><br />
        <input type="radio" name="gender" value="female" required>Female<br /><br />
        <label for="DOB"><b>Hospitals/Clinic Address:</b></label><br /><br />
        <input type="text" class="form-control" size="50" name="address" placeholder="Enter Clinic/Hospital Address" required><br /><br />
        <label for="bmdc_reg_num"><b>BMDC Registration Number:</b></label><br /><br />
        <input type="text" class="form-control" size="50" name="bmdc_reg_num" placeholder="Enter Your Registration Number" required>
        <p><strong>Only input Numeric Number, Without A-(like 1,2,3).</strong></p>
        <br /><br />
        <label for="pswd"><i class="fa fa-key icon"></i> Create New Password :</label><br /><br />
        <input type="password" class="form-control" size="50" placeholder="Create Your Password" name="pswd" required>
