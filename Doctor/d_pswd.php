...
<ul class="text-center font-weight-bold text-monospace text-dark">
    <form class=" text-center text-xl-info font-weight-bold" action="d_pswd.php" method="POST">
        Change Password: 
        <input type="password" name="pswd" placeholder="Password should be more than 8 characters long">
