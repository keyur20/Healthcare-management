        ...
        <table border="1" cellpadding="13" align="center" class="table table-hover table-dark">
            <thead>
                <tr>
                    ...
                    <th class="active">
                        <h2><input class="alert-danger" type="submit" value="Delete" name="submit"></h2>
                    </th>
                </tr>
            </thead>
            <?php
            ...
            ?>
                <tr>
                    <th>
                        <h3><?php echo "<a href='detail.php?s_id={$row['s_id']}'>{$row['f_name']}{$row['l_name']}</a>";  ?></h3>
                    </th>
                    <th>
                        <h3><?php echo  $row['specialist'] . "<br />"; ?></h3>
                    </th>
