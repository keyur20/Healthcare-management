                ...
                <div class="w3-container">
                    ...
                    <form action="add_doctor.php" method="POST">
                        <div class="container text-white font-weight-bold">
                            ...
                            <hr color="#333333" />
                            <label for="f_name"><b>First Name:</b></label><br /><br />
                            <input class="text-dark" type="text" placeholder="Enter First Name" name="f_name" required><br /><br />
                            <label for="l_name"><b>Last Name:</b></label><br /><br />
                            <input class="text-dark" type="text" placeholder="Enter Last Name" name="l_name" required><br /><br />
                            <label for="email"><b>Email:</b></label><br /><br />
                            <input class="text-dark" type="email" placeholder="Enter Email" name="email" required><br /><br />
                            <label for="specialist"><b>Specialist:</b></label><br /><br />
                            <select class="text-dark" name="specialist" required>
                            ...
                            <input class="text-dark" type="text" placeholder="Enter Designation" name="qualification" required><br /><br />
                            <label for="pswd"><b>Create New Password:</b></label><br /><br />
                            <input class="text-dark" type="password" placeholder="Create Password" name="pswd" required>
                            <p>Password should be more than 8 characters long</p>
                            <br /><br />
                            <input class="text-dark" class="text-capitalize font-weight-bold" type="submit" name="submit" value="Register">
                        </div>
                        <?php
                        if (isset($error_msg)) {
                            echo $error_msg;
